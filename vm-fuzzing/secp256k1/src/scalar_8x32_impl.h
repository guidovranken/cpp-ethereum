...
SECP256K1_INLINE static int cppethsecp256k1_scalar_reduce(cppethsecp256k1_scalar *r, uint32_t overflow) {
    uint64_t t;
...
static void cppethsecp256k1_scalar_negate(cppethsecp256k1_scalar *r, const cppethsecp256k1_scalar *a) {
    uint32_t nonzero = 0xFFFFFFFFUL * (cppethsecp256k1_scalar_is_zero(a) == 0);
...
static int cppethsecp256k1_scalar_cond_negate(cppethsecp256k1_scalar *r, int flag) {
    ...
    uint32_t nonzero = 0xFFFFFFFFUL * (cppethsecp256k1_scalar_is_zero(r) == 0);
...
static void cppethsecp256k1_scalar_reduce_512(cppethsecp256k1_scalar *r, const uint32_t *l) {
    uint64_t c;
...
static void cppethsecp256k1_scalar_mul_512(uint32_t *l, const cppethsecp256k1_scalar *a, const cppethsecp256k1_scalar *b) {
    /* 96 bit accumulator. */
...
static void cppethsecp256k1_scalar_sqr_512(uint32_t *l, const cppethsecp256k1_scalar *a) {
    /* 96 bit accumulator. */
    uint32_t c0 = 0, c1 = 0, c2 = 0;
...
SECP256K1_INLINE static void cppethsecp256k1_scalar_mul_shift_var(cppethsecp256k1_scalar *r, const cppethsecp256k1_scalar *a, const cppethsecp256k1_scalar *b, unsigned int shift) {
    ...
    cppethsecp256k1_scalar_cadd_bit(r, 0, (l[(shift - 1) >> 5] >> ((shift - 1) & 0x1f)) & 1);
}
