...
/* Limbs of the cppethsecp256k1 order. */
#define SECP256K1_N_0 ((uint64_t)0xBFD25E8CD0364141ULL)
#define SECP256K1_N_1 ((uint64_t)0xBAAEDCE6AF48A03BULL)
#define SECP256K1_N_2 ((uint64_t)0xFFFFFFFFFFFFFFFEULL)
#define SECP256K1_N_3 ((uint64_t)0xFFFFFFFFFFFFFFFFULL)

/* Limbs of 2^256 minus the cppethsecp256k1 order. */
#define SECP256K1_N_C_0 (~SECP256K1_N_0 + 1)
#define SECP256K1_N_C_1 (~SECP256K1_N_1)
#define SECP256K1_N_C_2 (1)

/* Limbs of half the cppethsecp256k1 order. */
#define SECP256K1_N_H_0 ((uint64_t)0xDFE92F46681B20A0ULL)
#define SECP256K1_N_H_1 ((uint64_t)0x5D576E7357A4501DULL)
#define SECP256K1_N_H_2 ((uint64_t)0xFFFFFFFFFFFFFFFFULL)
#define SECP256K1_N_H_3 ((uint64_t)0x7FFFFFFFFFFFFFFFULL)

SECP256K1_INLINE static void cppethsecp256k1_scalar_clear(cppethsecp256k1_scalar *r) {
    r->d[0] = 0;
    r->d[1] = 0;
    r->d[2] = 0;
    r->d[3] = 0;
...
SECP256K1_INLINE static void cppethsecp256k1_scalar_set_int(cppethsecp256k1_scalar *r, unsigned int v) {
    r->d[0] = v;
    r->d[1] = 0;
    r->d[2] = 0;
    r->d[3] = 0;
...
SECP256K1_INLINE static int cppethsecp256k1_scalar_check_overflow(const cppethsecp256k1_scalar *a) {
    int yes = 0;
    int no = 0;
...
SECP256K1_INLINE static int cppethsecp256k1_scalar_reduce(cppethsecp256k1_scalar *r, unsigned int overflow) {
    uint128_t t;
...
static int cppethsecp256k1_scalar_add(cppethsecp256k1_scalar *r, const cppethsecp256k1_scalar *a, const cppethsecp256k1_scalar *b) {
    ...
    overflow = t + cppethsecp256k1_scalar_check_overflow(r);
    VERIFY_CHECK(overflow == 0 || overflow == 1);
    cppethsecp256k1_scalar_reduce(r, overflow);
    return overflow;
}
...
static void cppethsecp256k1_scalar_set_b32(cppethsecp256k1_scalar *r, const unsigned char *b32, int *overflow) {
    ...
    over = cppethsecp256k1_scalar_reduce(r, cppethsecp256k1_scalar_check_overflow(r));
    if (overflow) {
        *overflow = over;
    }
}
...
static void cppethsecp256k1_scalar_negate(cppethsecp256k1_scalar *r, const cppethsecp256k1_scalar *a) {
    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (cppethsecp256k1_scalar_is_zero(a) == 0);
...
static int cppethsecp256k1_scalar_cond_negate(cppethsecp256k1_scalar *r, int flag) {
     ...
     * if we are flag = 1, mask = 11...11 and this is identical to cppethsecp256k1_scalar_negate */
    uint64_t mask = !flag - 1;
    uint64_t nonzero = (cppethsecp256k1_scalar_is_zero(r) != 0) - 1;
...
static void cppethsecp256k1_scalar_reduce_512(cppethsecp256k1_scalar *r, const uint64_t *l) {
    ...
    cppethsecp256k1_scalar_reduce(r, c + cppethsecp256k1_scalar_check_overflow(r));
}

static void cppethsecp256k1_scalar_mul_512(uint64_t l[8], const cppethsecp256k1_scalar *a, const cppethsecp256k1_scalar *b) {
#ifdef USE_ASM_X86_64
...
static void cppethsecp256k1_scalar_sqr_512(uint64_t l[8], const cppethsecp256k1_scalar *a) {
#ifdef USE_ASM_X86_64
    __asm__ __volatile__(
    /* Preload */
    "movq 0(%%rdi), %%r11\n"
...
static void cppethsecp256k1_scalar_mul(cppethsecp256k1_scalar *r, const cppethsecp256k1_scalar *a, const cppethsecp256k1_scalar *b) {
    uint64_t l[8];
    cppethsecp256k1_scalar_mul_512(l, a, b);
    cppethsecp256k1_scalar_reduce_512(r, l);
}
...
static void cppethsecp256k1_scalar_sqr(cppethsecp256k1_scalar *r, const cppethsecp256k1_scalar *a) {
    uint64_t l[8];
    cppethsecp256k1_scalar_sqr_512(l, a);
    cppethsecp256k1_scalar_reduce_512(r, l);
}
...
SECP256K1_INLINE static void cppethsecp256k1_scalar_mul_shift_var(cppethsecp256k1_scalar *r, const cppethsecp256k1_scalar *a, const cppethsecp256k1_scalar *b, unsigned int shift) {
    uint64_t l[8];
    ...
    cppethsecp256k1_scalar_cadd_bit(r, 0, (l[(shift - 1) >> 6] >> ((shift - 1) & 0x3f)) & 1);
}
